...
## ★  TO-BE 조직 (개인과제 조직 추가)
  ![image](https://user-images.githubusercontent.com/36434874/81881032-149d3180-95ca-11ea-942a-3f792f182b44.png)

[조직 KPI]
예약팀 : 고객의 예약을 최대한 많이 받아야 함.
결제팀 : 결제 안정성을 최대한 확보해야 함.
객실관리팀 : 고객의 객실평가 점수가 높아야 함.
★ 사업자관리팀 : 객실사업자의 관심인 사업자 평가 점수가 높아야 함.
...
## ★ Event Storming ★ 결과
* 기존 모델에서 신규 추가된 모델과 연계가 있는 모델과의 이벤트스토밍 결과:
![image](https://user-images.githubusercontent.com/36434874/81878700-cc7b1080-95c3-11ea-9868-d3ae09ba7787.png)
...
기능적 요구사항
    ...
    - ★ 사업관리담당자는 객실사업자 정보를 수정할 수 있다.
    - ★ 객실평가 정보가 등록되면 객실사업자 평가가 연계해서 변경된다. 
